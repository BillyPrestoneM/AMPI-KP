...
class TimeFragment : Fragment() {
    ...
    private fun setupRecyclerViews(inflater: LayoutInflater) {
        ...
        adapterQuadrant1 = DailyTaskAdapter(emptyList())
        ...
        adapterQuadrant2 = DailyTaskAdapter(emptyList())
        ...
        adapterQuadrant3 = DailyTaskAdapter(emptyList())
        ...
        adapterQuadrant4 = DailyTaskAdapter(emptyList())
